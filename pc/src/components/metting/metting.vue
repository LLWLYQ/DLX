<template>
  <div class="baseW-1100">
    ...
    <!-- 演讲嘉宾 -->
    <guest-list title="演讲嘉宾" :titleLeft="true" :result="result.now"></guest-list>
    <!-- 往届演讲嘉宾 -->
    <guest-list :titleLeft="true" :result="result.past"></guest-list>
    <!--会议论坛-->
    <div class="metting-page MgT70">
        <div class="base-tit-left">
            <h1>会议论坛</h1>
        </div>
        <div class="MgT30">
          <img src="../../image/meeting.png" width="100%"/>
          <img src="http://lib.albers.top/activity/5g/metting-banner.png" alt="">
        </div>
    </div>
    <!--议程安排-->
    <!-- <div class="agenda MgT70">
      <div class="base-tit-left">
          <h1>议程安排</h1>
      </div>
    ...
    <!--参会嘉宾-->
    <div class="metting-guest baseW-1100 MgT70">
      <div class="  base-tit-left">
          <h1>参会嘉宾</h1>
      </div>
      <div class="metting-guest-box MgT30">
          ...
          <router-link to="/guest_login" class="apply MgT70">听众报名</router-link>
      </div>
    </div>
    <Footer />
  </div>
